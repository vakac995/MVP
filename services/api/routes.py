...
from core import project_service, voting_service, donation_service, timeline_service, comment_service, badge_service, registration_service
...
async def project_service_get_all_projects() -> GetAllProjectsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.get_all_projects)
    return response
...
async def project_service_get_project_by_id(body: BodyProjectServiceGetProjectById = Body(...)) -> GetProjectByIdOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.get_project_by_id, project_id=body.project_id)
    return response
...
async def project_service_get_featured_projects(body: BodyProjectServiceGetFeaturedProjects = Body(...)) -> GetFeaturedProjectsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.get_featured_projects, limit=body.limit)
    return response
...
async def project_service_search_projects(body: BodyProjectServiceSearchProjects = Body(...)) -> SearchProjectsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.search_projects, query=body.query)
    return response
...
async def project_service_get_projects_by_category(body: BodyProjectServiceGetProjectsByCategory = Body(...)) -> GetProjectsByCategoryOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.get_projects_by_category, category=body.category)
    return response
...
async def project_service_create_project(body: BodyProjectServiceCreateProject = Body(...), current_user: User = Depends(get_current_user)) -> CreateProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.create_project, user=current_user, title=body.title, description=body.description, budget=body.budget, category=body.category, tags=body.tags)
    return response
...
async def project_service_update_project(body: BodyProjectServiceUpdateProject = Body(...), current_user: User = Depends(get_current_user)) -> UpdateProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.update_project, user=current_user, project_id=body.project_id, title=body.title, description=body.description, budget=body.budget, status=body.status, category=body.category, tags=body.tags)
    return response
...
async def project_service_delete_project(body: BodyProjectServiceDeleteProject = Body(...), current_user: User = Depends(get_current_user)) -> DeleteProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.delete_project, user=current_user, project_id=body.project_id)
    return response
...
async def project_service_get_project_statistics(body: BodyProjectServiceGetProjectStatistics = Body(...)) -> GetProjectStatisticsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(project_service.get_project_statistics, project_id=body.project_id)
    return response
...
async def voting_service_vote_for_project(body: BodyVotingServiceVoteForProject = Body(...), current_user: User = Depends(get_current_user)) -> VoteForProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(voting_service.vote_for_project, user=current_user, project_id=body.project_id)
    return response
...
async def voting_service_remove_vote_for_project(body: BodyVotingServiceRemoveVoteForProject = Body(...), current_user: User = Depends(get_current_user)) -> RemoveVoteForProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(voting_service.remove_vote_for_project, user=current_user, project_id=body.project_id)
    return response
...
async def voting_service_has_user_voted(body: BodyVotingServiceHasUserVoted = Body(...), current_user: User = Depends(get_current_user)) -> HasUserVotedOutputSchema:
    ...
    """
    response = await run_sync_in_thread(voting_service.has_user_voted, user=current_user, project_id=body.project_id)
    return response
...
async def voting_service_get_project_vote_count(body: BodyVotingServiceGetProjectVoteCount = Body(...)) -> GetProjectVoteCountOutputSchema:
    ...
    """
    response = await run_sync_in_thread(voting_service.get_project_vote_count, project_id=body.project_id)
    return response
...
async def voting_service_get_user_votes(current_user: User = Depends(get_current_user)) -> GetUserVotesOutputSchema:
    ...
    """
    response = await run_sync_in_thread(voting_service.get_user_votes, user=current_user)
    return response
...
async def voting_service_get_project_voters(body: BodyVotingServiceGetProjectVoters = Body(...)) -> GetProjectVotersOutputSchema:
    ...
    """
    response = await run_sync_in_thread(voting_service.get_project_voters, project_id=body.project_id, limit=body.limit)
    return response
...
async def donation_service_create_donation(body: BodyDonationServiceCreateDonation = Body(...), current_user: User = Depends(get_current_user)) -> CreateDonationOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.create_donation, user=current_user, project_id=body.project_id, amount=body.amount, message=body.message, is_anonymous=body.is_anonymous, currency=body.currency)
    return response
...
async def donation_service_get_project_donations(body: BodyDonationServiceGetProjectDonations = Body(...)) -> GetProjectDonationsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.get_project_donations, project_id=body.project_id, include_anonymous=body.include_anonymous)
    return response
...
async def donation_service_get_donation_statistics(body: BodyDonationServiceGetDonationStatistics = Body(...)) -> GetDonationStatisticsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.get_donation_statistics, project_id=body.project_id)
    return response
...
async def donation_service_get_user_donations(current_user: User = Depends(get_current_user)) -> GetUserDonationsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.get_user_donations, user=current_user)
    return response
...
async def donation_service_get_recent_donations(body: BodyDonationServiceGetRecentDonations = Body(...)) -> GetRecentDonationsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.get_recent_donations, limit=body.limit)
    return response
...
async def donation_service_get_top_donors_for_project(body: BodyDonationServiceGetTopDonorsForProject = Body(...)) -> GetTopDonorsForProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.get_top_donors_for_project, project_id=body.project_id, limit=body.limit)
    return response
...
async def donation_service_get_user_donation_total(current_user: User = Depends(get_current_user)) -> GetUserDonationTotalOutputSchema:
    ...
    """
    response = await run_sync_in_thread(donation_service.get_user_donation_total, user=current_user)
    return response
...
async def timeline_service_get_project_timeline(body: BodyTimelineServiceGetProjectTimeline = Body(...)) -> GetProjectTimelineOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.get_project_timeline, project_id=body.project_id)
    return response
...
async def timeline_service_create_timeline_item(body: BodyTimelineServiceCreateTimelineItem = Body(...), current_user: User = Depends(get_current_user)) -> CreateTimelineItemOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.create_timeline_item, user=current_user, project_id=body.project_id, title=body.title, description=body.description, milestone_type=body.milestone_type, target_date=body.target_date, order_index=body.order_index)
    return response
...
async def timeline_service_update_timeline_item(body: BodyTimelineServiceUpdateTimelineItem = Body(...), current_user: User = Depends(get_current_user)) -> UpdateTimelineItemOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.update_timeline_item, user=current_user, timeline_item_id=body.timeline_item_id, title=body.title, description=body.description, target_date=body.target_date, is_completed=body.is_completed)
    return response
...
async def timeline_service_delete_timeline_item(body: BodyTimelineServiceDeleteTimelineItem = Body(...), current_user: User = Depends(get_current_user)) -> DeleteTimelineItemOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.delete_timeline_item, user=current_user, timeline_item_id=body.timeline_item_id)
    return response
...
async def timeline_service_reorder_timeline_items(body: BodyTimelineServiceReorderTimelineItems = Body(...), current_user: User = Depends(get_current_user)) -> ReorderTimelineItemsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.reorder_timeline_items, user=current_user, project_id=body.project_id, item_order=body.item_order)
    return response
...
async def timeline_service_get_timeline_item_by_id(body: BodyTimelineServiceGetTimelineItemById = Body(...)) -> GetTimelineItemByIdOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.get_timeline_item_by_id, timeline_item_id=body.timeline_item_id)
    return response
...
async def timeline_service_get_recent_timeline_activity(body: BodyTimelineServiceGetRecentTimelineActivity = Body(...)) -> GetRecentTimelineActivityOutputSchema:
    ...
    """
    response = await run_sync_in_thread(timeline_service.get_recent_timeline_activity, limit=body.limit)
    return response
...
async def comment_service_get_project_comments(body: BodyCommentServiceGetProjectComments = Body(...)) -> GetProjectCommentsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.get_project_comments, project_id=body.project_id)
    return response
...
async def comment_service_get_timeline_item_comments(body: BodyCommentServiceGetTimelineItemComments = Body(...)) -> GetTimelineItemCommentsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.get_timeline_item_comments, timeline_item_id=body.timeline_item_id)
    return response
...
async def comment_service_get_threaded_comments(body: BodyCommentServiceGetThreadedComments = Body(...)) -> GetThreadedCommentsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.get_threaded_comments, project_id=body.project_id, timeline_item_id=body.timeline_item_id)
    return response
...
async def comment_service_create_comment(body: BodyCommentServiceCreateComment = Body(...), current_user: User = Depends(get_current_user)) -> CreateCommentOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.create_comment, user=current_user, project_id=body.project_id, content=body.content, timeline_item_id=body.timeline_item_id, parent_comment_id=body.parent_comment_id)
    return response
...
async def comment_service_update_comment(body: BodyCommentServiceUpdateComment = Body(...), current_user: User = Depends(get_current_user)) -> UpdateCommentOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.update_comment, user=current_user, comment_id=body.comment_id, content=body.content)
    return response
...
async def comment_service_delete_comment(body: BodyCommentServiceDeleteComment = Body(...), current_user: User = Depends(get_current_user)) -> DeleteCommentOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.delete_comment, user=current_user, comment_id=body.comment_id)
    return response
...
async def comment_service_get_recent_comments(body: BodyCommentServiceGetRecentComments = Body(...)) -> GetRecentCommentsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.get_recent_comments, limit=body.limit)
    return response
...
async def comment_service_get_comment_count_for_project(body: BodyCommentServiceGetCommentCountForProject = Body(...)) -> GetCommentCountForProjectOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.get_comment_count_for_project, project_id=body.project_id)
    return response
...
async def comment_service_get_user_comments(current_user: User = Depends(get_current_user)) -> GetUserCommentsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.get_user_comments, user=current_user)
    return response
...
async def comment_service_search_comments(body: BodyCommentServiceSearchComments = Body(...)) -> SearchCommentsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(comment_service.search_comments, query=body.query, project_id=body.project_id)
    return response
...
async def badge_service_get_all_badges() -> GetAllBadgesOutputSchema:
    ...
    """
    response = await run_sync_in_thread(badge_service.get_all_badges)
    return response
...
async def badge_service_get_project_badges(body: BodyBadgeServiceGetProjectBadges = Body(...)) -> GetProjectBadgesOutputSchema:
    ...
    """
    response = await run_sync_in_thread(badge_service.get_project_badges, project_id=body.project_id)
    return response
...
async def badge_service_get_user_badges(body: BodyBadgeServiceGetUserBadges = Body(...)) -> GetUserBadgesOutputSchema:
    ...
    """
    response = await run_sync_in_thread(badge_service.get_user_badges, user_id=body.user_id)
    return response
...
async def badge_service_set_featured_badge(body: BodyBadgeServiceSetFeaturedBadge = Body(...)) -> SetFeaturedBadgeOutputSchema:
    ...
    """
    response = await run_sync_in_thread(badge_service.set_featured_badge, user_id=body.user_id, badge_id=body.badge_id)
    return response
...
async def badge_service_recalculate_badges() -> RecalculateBadgesOutputSchema:
    ...
    """
    response = await run_sync_in_thread(badge_service.recalculate_badges)
    return response
...
async def registration_service_check_username_availability(body: BodyRegistrationServiceCheckUsernameAvailability = Body(...)) -> CheckUsernameAvailabilityOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.check_username_availability, username=body.username)
    return response
...
async def registration_service_check_email_availability(body: BodyRegistrationServiceCheckEmailAvailability = Body(...)) -> CheckEmailAvailabilityOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.check_email_availability, email=body.email)
    return response
...
async def registration_service_validate_password(body: BodyRegistrationServiceValidatePassword = Body(...)) -> ValidatePasswordOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.validate_password, password=body.password)
    return response
...
async def registration_service_register_user(body: BodyRegistrationServiceRegisterUser = Body(...)) -> RegisterUserOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.register_user, email=body.email, password=body.password, username=body.username, full_name=body.full_name, phone_number=body.phone_number, location=body.location, bio=body.bio, newsletter_opt_in=body.newsletter_opt_in, terms_accepted=body.terms_accepted)
    return response
...
async def registration_service_send_verification_email(body: BodyRegistrationServiceSendVerificationEmail = Body(...)) -> SendVerificationEmailOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.send_verification_email, user_id=body.user_id)
    return response
...
async def registration_service_verify_email(body: BodyRegistrationServiceVerifyEmail = Body(...)) -> VerifyEmailOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.verify_email, user_id=body.user_id, verification_token=body.verification_token)
    return response
...
async def registration_service_get_registration_stats() -> GetRegistrationStatsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.get_registration_stats)
    return response
...
async def registration_service_update_user_profile(body: BodyRegistrationServiceUpdateUserProfile = Body(...)) -> UpdateUserProfileOutputSchema:
    ...
    """
    response = await run_sync_in_thread(registration_service.update_user_profile, user_id=body.user_id, full_name=body.full_name, phone_number=body.phone_number, location=body.location, bio=body.bio, newsletter_opt_in=body.newsletter_opt_in)
    return response
